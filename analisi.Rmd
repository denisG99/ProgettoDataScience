...
```{r warning=FALSE, message=FALSE}
#TODO: sistemare
corrplot(as.matrix(cramerV_table), method = "square")
```


Dall'analisi della tabella soprastante tra sistemi di sicurezza implementati e le consegueze degli attacchi non c'è alcuna correlazione forte tranne per qualche eccezione.
