...
```{r warning=FALSE, message=FALSE}
attacks  %>% filter(Year > 2004 & Records < 10000000) %>%
...
```
<!--realizzare ananlisi -->
 <!--vedere legame presente tra il numero di record estratti e la dimensione dell'azienda / dimensione dell'azienda (confronta demo diamonds.Rmd)-->
