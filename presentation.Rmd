...
Da come viene mostrato dal grafico soprastante il settore che è stato maggiormente colpito è quello delle **Human health activities** con un totale di 318 attacchi il quale risulta circa il doppia del settore subito sotto, che è quello del **web** con un totale di 137 attacchi dal 2004 al 2022.
...
In generale a livello di sistemi di sicurezza ,il settore è messo abbastanza bene ma ci sono un paio di cose che sorgono all'occhio: 
...
```
In linea generale non c'è alcuna correlazione forte tra sistemi di sicurezza e conseguenze dell'attacco.
