...
Analizzando i vari sistemi di sicurezza implemetati all'interno delle aziende che lavorano nel settore preso in considerazione, si ottngono i seguenti risultati
...
* circa 200 aziende non usano la cifratura che è causa di un eventiuale pubblicazione dei dati esfiltrati illecitamete;
* non usano alcun cybersecurity framework il quale fornisce delle linee guida e le best practice per ottenere un sistema sicura;
* in nessuna di queste ha una politica di educazione e sensibilizzazione del personale che potrbbe essere la causa principale di questo numero spropositato di attacchi, quindi il fattore umano protrebbe essere la maggior causa di attacco.

<!--Da questa analisi si potrebbe dedurre che il fatto dell'assenza di cifratura è causa di un eventuale pubblicazione dei dati esfiltrati illecitamente, ma non spiega il perchè dell'attacco, -->
...
Il volume di dati rubati sembra che tende ad aumentare con l'andare avanti con gli anni raggiungendo il suo picco nel 2022, anche se sono avvenuti un numero inferiore di attacchi.
...
Per calcolare la un possibile legame tra sistemi di sicurezza e conseguenze dell'attcco uso la **V di Cramer** il quale,
...
In linea generale non c'è alcuna correlazione tra sistemi di sicurezza e conseguenze dell'attacco.
